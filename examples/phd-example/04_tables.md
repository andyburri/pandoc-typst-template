...
+-----------------+---------+------------+---------------+-------------+-------------+------------+
| Landmass        | % stuff |  Number of |  Dolphins per |    How Many |    How Many |  Forbidden |
|                 |         |       Owls |        Capita |        Foos |        Bars |      Float |
+:================+========:+===========:+==============:+============:+============:+===========:+
...
: Important data for various land masses. {short-caption="Table short caption" typst:fill=striped align=left #tbl:random}
